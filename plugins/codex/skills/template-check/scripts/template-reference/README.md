...
Files added to this template later do not reach a project that copied it earlier. The plugin ships
a read-only copy of this directory as a reference; `/template-check` lists what your project lacks
or has with different content, and changes nothing.
