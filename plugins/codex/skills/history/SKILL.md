...
```bash
python3 scripts/handoff.py history --project-dir "<지금 작업 중인 사용자 프로젝트 절대경로>" --from both --limit 20 --since 30d
python3 scripts/handoff.py history --project-dir "<지금 작업 중인 사용자 프로젝트 절대경로>" --grep "useStudyProgress" --since 7d
python3 scripts/handoff.py history --project-dir "<지금 작업 중인 사용자 프로젝트 절대경로>" --no-content
```
